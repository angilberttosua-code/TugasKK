...
const skillGroups: SkillGroup[] = [
  {
    ...
    icon: "💻",
    skills: [
      { name: "HTML5 / CSS3", level: "Advanced", percentage: 40 },
      { name: "JavaScript (ES6+)", level: "Advanced", percentage: 60 },
      { name: "React.js", level: "Intermediate", percentage: 65 },
      { name: "Next.js (App Router)", level: "Intermediate", percentage: 60 },
      { name: "Tailwind CSS", level: "Advanced", percentage: 55 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js", level: "Intermediate", percentage: 65 },
      { name: "MySQL", level: "Intermediate", percentage: 65 },
      { name: "RESTful API Development", level: "Intermediate", percentage: 60 },
    ],
  },
  {
    ...
    icon: "🛠️",
    skills: [
      { name: "Git & GitHub", level: "Advanced", percentage: 70 },
      { name: "Figma (UI/UX)", level: "Intermediate", percentage: 40 },
      { name: "Postman", level: "Advanced", percentage: 60 },
      { name: "VS Code", level: "Advanced", percentage: 70 },
    ],
  },
];
