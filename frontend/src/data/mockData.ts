...
const skillGroups: SkillGroup[] = [
  {
    ...
    icon: "💻",
    skills: [
      { name: "HTML5 / CSS3", level: "Advanced", percentage: 60 },
      { name: "JavaScript (ES6+)", level: "Advanced", percentage: 75 },
      { name: "React.js", level: "Intermediate", percentage: 70 },
      { name: "Next.js (App Router)", level: "Intermediate", percentage: 65 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MySQL", level: "Intermediate", percentage: 85 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Postman", level: "Advanced", percentage: 70 },
